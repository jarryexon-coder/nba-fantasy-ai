// src/navigation/GroupedTabNavigator.js - WITH NFL SCREEN
...
import NFLScreen from '../screens/NFLScreen-enhanced';  // ADDED BACK
...
// Sports Stack - NOW WITH NFL SCREEN
function SportsStack() {
  return (
    <SearchProvider>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        <Stack.Screen name="LiveGames" component={LiveGamesScreen} />
        <Stack.Screen name="NFL" component={NFLScreen} />  {/* ORIGINAL SCREEN ADDED BACK */}
