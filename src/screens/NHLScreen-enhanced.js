...
const NHLScreen = () => {
  ...
  const handleNavigateToPlayerStats = (player) => {
    ...
    logAnalyticsEvent('nhl_navigate_player_stats', {
      player_name: player?.name || player?.player || 'Unknown',
      team: player?.team || 'Unknown',
      screen_name: 'NHL Screen'
    });
  };

  const handleNavigateToAnalytics = () => {
    navigation.goToAnalytics();
    logAnalyticsEvent('nhl_navigate_analytics', {
      tab: selectedTab,
      screen_name: 'NHL Screen'
    });
  };
  ...
  const handleNavigateToPredictions = () => {
    ...
    logAnalyticsEvent('nhl_navigate_predictions', {
      tab: selectedTab,
      screen_name: 'NHL Screen'
    });
  };
  ...
  const handleNavigateToFantasy = () => {
    ...
    logAnalyticsEvent('nhl_navigate_fantasy', {
      tab: selectedTab,
      screen_name: 'NHL Screen'
    });
  };
  ...
  const renderNavigationMenu = () => (
    <View style={styles.navigationMenu}>
      <TouchableOpacity 
        ...
        onPress={() => handleNavigateToPlayerStats(players?.[0])}
        activeOpacity={0.7}
      >
      ...
      <View style={styles.contentSection}>
        ...
        {gamesToRender.map((game, index) => {
          ...
          return (
            <TouchableOpacity 
              ...
              activeOpacity={0.7}
              onPress={() => {
                // Navigate to GameDetailsScreen when a game is clicked
                navigation.goToGameDetails();
                logAnalyticsEvent('nhl_game_selected', {
                  game_id: game.id || index,
                  away_team: awayTeam,
                  home_team: homeTeam,
                  status: status,
                });
        ...
        <View style={styles.quickActionsRow}>
          ...
          >
            ...
            <Text style={styles.quickActionSmallText}>Full Analytics</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={styles.quickActionSmall}
            onPress={() => handleNavigateToPredictions()}
      ...
      <View style={styles.contentSection}>
        ...
        {standingsToRender.map((team, index) => (
          <TouchableOpacity 
            ...
            activeOpacity={0.7}
            onPress={() => {
              // Navigate to team analytics when a team is clicked
              handleNavigateToAnalytics();
              logAnalyticsEvent('nhl_team_selected', {
    ...
    return (
      <View style={styles.contentSection}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => handleNavigateToPlayerStats(playersToRender[0])}
        >
          <Ionicons name="stats-chart" size={16} color="#0ea5e9" />
          <Text style={styles.quickActionText}>View All Player Stats</Text>
        ...
        <View style={styles.insightsSection}>
          ...
          >
            ...
            <View style={styles.insightContent}>
              <Text style={styles.insightTitle}>Advanced Analytics</Text>
              <Text style={styles.insightText}>
                Dive deeper into team and player analytics with advanced metrics and visualizations
              </Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity 
          ...
          >
            ...
            <View style={styles.insightContent}>
              ...
              <Text style={styles.insightText}>
                Get AI-powered predictions for upcoming games and player performance
              </Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity 
          ...
          >
            ...
            <View style={styles.insightContent}>
              <Text style={styles.insightTitle}>Fantasy Tools</Text>
              <Text style={styles.insightText}>
                Optimize your fantasy hockey lineup with player insights and matchup analysis
              </Text>
            </View>
          </TouchableOpacity>
        </View>
