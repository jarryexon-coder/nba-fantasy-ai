      ...
      <View style={styles.insightsCard}>
        ...
        <View style={styles.insightItem}>
          <Text style={styles.insightText}>
            • Stephen Curry's three-point accuracy is most predictable (94% accuracy)
          </Text>
        </View>
        <View style={styles.insightItem}>
          <Text style={styles.insightText}>
            • Jokić's efficiency rating predictions are most reliable
          </Text>
        </View>
        <View style={styles.insightItem}>
          <Text style={styles.insightText}>
            • Giannis's free throw predictions need more training data
          </Text>
        </View>
      </View>
