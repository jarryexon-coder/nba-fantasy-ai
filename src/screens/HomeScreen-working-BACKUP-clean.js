// src/screens/HomeScreen-HYBRID.js
...
export default function HomeScreen({ navigation }) {
  // Navigation helper - knows which screens work
  const navigateToScreen = (screenName) => {
    ...
    // Screens that WORK (use original files)
    const workingScreens = ['LiveGames', 'Fantasy', 'Predictions', 'ParlayArchitect'];
    if (workingScreens.includes(screenName)) {
    ...
    // Screens that show PLACEHOLDER (original files have issues)
    const placeholderScreens = [
      'NFL', 'NHLStatsTrends', 'SportsWire', 
      'PlayerMetrics', 'PlayerDashboard', 'MatchAnalytics',
      'ExpertSelections', 'Login', 'PremiumAccess'
    ];
    
    if (placeholderScreens.includes(screenName)) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Hybrid Mode - Some features restored</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDescription}>These screens are fully functional</Text>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionTitle}>In Development</Text>
          </View>
          <Text style={styles.sectionDescription}>These screens show placeholder while being fixed</Text>
          ...
          <View style={styles.tabsContainer}>
            ...
            >
              ...
              <View style={styles.devBadge}>
                <Text style={styles.devBadgeText}>IN DEV</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.devBadge}>
                <Text style={styles.devBadgeText}>TESTING</Text>
              </View>
            </TouchableOpacity>
